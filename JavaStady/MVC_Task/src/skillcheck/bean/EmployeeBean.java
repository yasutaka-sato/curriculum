...
public final class EmployeeBean {
    ...
    /** ・社員番号 */
    private String _empId = "298";
    /** ・パスワード */
    private String _password = "yasu0895";
    /** ・名前 */
    private String _name = "佐藤泰隆";
    /** ・メールアドレス */
    private String _mail = "yasu.0895@gmail.com";
    /** ・得意言語 or 学習中の言語 */
    private String _programingLanguage = "java";
    /** ・コメント（一言） */
    private String _comment = "コツコツやります。";
    /** ・削除フラグ（0:未削除/1:削除） */
    private String _deleteFlg = "0";
